...
<?php
// grafico_equipamentos.php
include "conexao.php";

/*
ESTRUTURA ESPERADA DA TABELA equipamentos
id
nome
estado (funcional | avariado)
data_registro (DATE ou DATETIME)
*/
...
<div class="chart-container">
  <canvas id="grafico-equipamentos"></canvas>
</div>
...
<script>
  ...
  const ctx = document.getElementById("grafico-equipamentos").getContext("2d");
  new Chart(ctx, {
    type: "line",
    data: data,
    options: options
